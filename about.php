    ...
    <div class="row">
      <div class="col-12">
        <div class="d-flex align-items-center section-title justify-content-between">
          <h2 class="mb-0 text-nowrap mr-3">Activities</h2>
...
<div class="row justify-content-center">
    ...
    <img class="card-img-top rounded-0" src="images/activities/activity1.png" alt="Post thumb" style="height:300px;">
      <div class="card-body">
        ...
        <a href="blog-single.html">
          <h4 class="card-title">Branch Launching</h4>
        </a>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
    <img class="card-img-top rounded-0" src="images/activities/activity3.png" style="height: 300px;" alt="Post thumb">
      <div class="card-body">
        <!-- post meta -->
        <ul class="list-inline mb-3">
          <!-- post date -->
