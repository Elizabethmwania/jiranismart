...
<div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">We provide different loan products instantly with quick approval that suit your term</p>
                    </div>
                </div>
            </div>
<div class="row justify-content-center">
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="images/products/product1.jpg" alt="course thumb" style="height: 300px;">
      <div class="card-body">
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="images/products/product2.jpg" alt="course thumb"style="height: 300px;">
      <div class="card-body">
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="images/products/product3.jpg" alt="course thumb"style="height: 300px;">
      <div class="card-body">
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="images/products/product4.jpg" alt="course thumb"style="height: 300px;">
      <div class="card-body">
        
        <a href="course-single.html">
          <h4 class="card-title">Uwezo ABF Loan (ABF)</h4>
        </a>
        <p class="card-text mb-4"> 
          This is for all normal products above Ksh. 20,000.<br/>
          Loan term is 1 to 9 months. <br/>
          No grace period.
        </p>
      </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="images/products/product5.png" alt="course thumb" style="height: 300px;">
      <div class="card-body">
      <h4 class="card-title">Jirani Jumbo Loan(JJL)</h4>
        <p class="card-text mb-4"> 
          This is for all normal products between Ksh. 100,000 and Ksh. 500,000.<br/>
          Loan term is 12-24 months. <br/>
          No grace period.
        </p>
      </div>
    </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      <img class="card-img-top rounded-0" src="images/products/product6.jpg" alt="course thumb"style="height: 300px;">
      <div class="card-body">
      <h4 class="card-title">Staff Loan</h4>
        <p class="card-text mb-4"> 
          This is for all normal products of any amount.<br/>
          This loan is given to the staff Members. <br/>
          No grace period.
        </p>
      </div>
    </div>
...
<section class="section-sm bg-primary">
  <div class="container">
      ...
      <!-- <div class="col-md-3 col-sm-6 mb-4 mb-md-0"> -->
                ...
                <div class="col-lg-12">
                    <div class="section_title text-center mb-90">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">We provide online instant asset loans with quick approval that suit your term</p>
                    </div>
                </div>
    ...
    font-weight: 500;" >
                        ...
                        <p>Register to JSL in a group or individual loans.
                        You can register online or any nearest branch.
                        </p>
                    </div>
                </div>
      <!-- funfacts item -->
    ...
    font-weight: 500;"  >
                        ...
                        <p>Open saving account and deposit account. 
                          As the savings increase the more loans to apply </p>
                    </div>
                </div>
      <!-- funfacts item -->
      <div class="col-md-6 col-lg-4">
    ...
    font-weight: 500;" >
                        ...
                        <h3>Enjoy loans</h3>
                        <p>Apply different types of loans and get them instantly</p>
                    </div>
    </div>
  </div>
</section>
